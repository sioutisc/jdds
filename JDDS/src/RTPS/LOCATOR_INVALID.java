...
public class LOCATOR_INVALID {
	public static final Locator_t value = new Locator_t(LOCATOR_KIND_INVALID.value
			                                           ,LOCATOR_PORT_INVALID.value
			                                           ,LOCATOR_ADDRESS_INVALID.value
			                                           );
}
