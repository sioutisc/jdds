...
public class PropertiesLoader {
     ...
     *
     * @param propertyName a <code>String</code> representing the
     ...
     * "myApp.properties".
     * @param customEnvironmentProperties a properties set that is
     * used along with the system properties to resolve the properties
